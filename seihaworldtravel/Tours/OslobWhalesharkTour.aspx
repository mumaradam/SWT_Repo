<%@ Page Title="Oslob Whale Shark & Tumalog Falls -" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OslobWhalesharkTour.aspx.cs" Inherits="seihaworldtravel.Tours.OslobWhalesharkTour" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/oslob_header.jpg');">
        <div class="container position-relative">
            <h1>Oslob Whale Shark Tour with side Trip to Tumalog Falls</h1>
            <p>Adventure in South Cebu</p>
                    ...
                    <div class="p-4 shadow-sm rounded bg-white border">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="12" class="inclusions-cell" style="font-size: 0.9rem;">
                                        ...
                                        <ul class="ps-3 mt-2">
                                            ...
                                            <li>Brunch at a local restaurant with one round of drinks</li>
                                            <li>Pick up and Drop off (Cebu City & Mactan Hotel)</li>
                                            <li>Tumalog Falls Entrance Fees</li>
                                            <li>Bottled Water</li>
                                        </ul>
                                        <strong>Whale Shark Encounter:</strong>
                                        <ul class="ps-3 mt-2">
                                            <li>Whale Shark Encounter Briefing & Permit</li>
                                            <li>Whale Shark Viewing & Snorkeling Fees</li>
                                            <li>Banca(boat) with Steward</li>
                                        </ul>
                                        <strong>Highlights:</strong>
                                        <ul class="ps-3 mt-2">
                                            <li>Whale Shark Encounter</li>
                                            <li>Side Trip to Tumalog Falls</li>
                                            <li>Running Tour/Picture Taking:<br /> Baluarte, Cuartel, Immaculate Conception Church and Carcar Pasalubong</li>
                                        </ul>
                                        <div class="mt-3 p-2 border-top">
                                            <strong>Note:</strong> Guests are advised to bring swimwear and extra towels. Pick-up time is strictly observed for slot availability.
                                        </div>
                                    </td>
                                </tr>
                                <tr><td>2 Persons</td><td>PHP 4,800</td></tr>
                                <tr><td>3 Persons</td><td>PHP 3,800</td></tr>
                                <tr><td>4 Persons</td><td>PHP 3,300</td></tr>
                                <tr><td>5 Persons</td><td>PHP 3,000</td></tr>
                                <tr><td>6-12 Persons</td><td>PHP 2,700</td></tr>
                                <tr><td>7 Persons</td><td>PHP 2,700</td></tr>
                                <tr><td>8 Persons</td><td>PHP 2,700</td></tr>
                                <tr><td>9 Persons</td><td>PHP 2,700</td></tr>
                                <tr><td>10 Persons</td><td>PHP 2,700</td></tr>
                                <tr><td>11 Persons</td><td>PHP 2,700</td></tr>
                                <tr><td>12 Persons</td><td>PHP 2,700</td></tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                ...
                                <tr><th class="bg-light">Schedule</th><td>Tuesday to Sunday | <strong>Pick up time: 3:00 AM </strong></td></tr>
                                <tr><th class="bg-light">Add on DOT Guide</th><td>1-4 Pax: P 3000 &emsp; 5-9 Pax: P 3500 &emsp; 10-12 Pax: P 4000 &emsp;</td></tr>
                                <tr><th class="bg-light">Duration</th><td>10 Hours</td></tr>
                                <tr><th class="bg-light">Location</th><td>Oslob, South Cebu(approx. 3 hours travel duratin from City)</td></tr>
                                <tr><th class="bg-light">What to Bring</th><td>Towels, change of clothes</td></tr>
                                <tr>
                                 ...
                                 <tr>
                                      ...
                                      <td><strong>Tumalog Falls CLOSED Every 2<sup>nd</sup> Wednesday of the month for clean up </strong><strong>SINULOG:</strong> January 18-19 | <strong>CHRISTMAS:</strong> December 24-25 | <strong>NEW YEAR:</strong> December 31-Jan 1 | <strong> HOLY WEEK:</strong> April 2-3</td>
                                  </tr>
                                  <tr>
