...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/siraoheader.jpg');">
        <div class="container position-relative">
            <h1>Cebu City with Highland Vista Tour</h1>
            <p>Sirao Garden & Temple of Leah</p>
                    ...
                    <div class="p-4 shadow-sm rounded bg-white border">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td rowspan="12" class="inclusions-cell" style="font-size: 0.9rem;">
                                        ...
                                        <ul class="ps-3 mt-2">
                                            <li>Sirao Flower Farm (Little Amsterdam)</li>
                                            <li>Temple of Leah (Cebu's Taj Mahal)</li>
                                            <li>Tops Lookout or La Vie in the Sky</li>
                                ...
                                <tr><td>2 Persons</td><td>PHP 3,100</td></tr>
                                <tr><td>3 Persons</td><td>PHP 2,400</td></tr>
                                <tr><td>4 Persons</td><td>PHP 2,100</td></tr>
                                <tr><td>5 Persons</td><td>PHP 1,900</td></tr>
                                <tr><td>6-12 Persons</td><td>PHP 1,700</td></tr>
                                <tr><td>7 Persons</td><td>PHP 1,700</td></tr>
                                <tr><td>8 Persons</td><td>PHP 1,700</td></tr>
                                <tr><td>9 Persons</td><td>PHP 1,700</td></tr>
                                <tr><td>10 Persons</td><td>PHP 1,700</td></tr>
                                <tr><td>11 Persons</td><td>PHP 1,700</td></tr>
                                <tr><td>12 Persons</td><td>PHP 1,700</td></tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                ...
                                <tr><th class="bg-light">Schedule</th><td>Daily | <strong>Pick up time: 8:00 AM </strong></td></tr>
                                <tr><th class="bg-light">Duration</th><td>6-7 Hours</td></tr>
                                <tr><th class="bg-light">Location</th><td>Cebu City, Busay</td></tr>
                                <tr><th class="bg-light">Value Added</th><td>Included Pick up and Drop off any Hotel or any point of Cebu City and Mactan</td></tr>
                                <tr>
                                    <th class="bg-light">Child Rate</th>
                                    <td>3 years old & below – <strong>Free</strong><br />
                            ...
                            <h3 class="mt-5 mb-4" style="color: #012970; font-weight: 700;">Tour Gallery</h3>
                                 <div id="tourGalleryCarousel" class="carousel slide shadow-sm rounded overflow-hidden mb-4" data-bs-ride="carousel">
                                     ...
                                     <div class="carousel-inner">
                                         ...
                                         <div class="carousel-item">
                                             <div class="gallery-item-wrapper">
                                                 <img src="../../assets/img/Tour/SiraoGarden.jpg" class="d-block w-100" alt="Sirao Garden" style="height: 400px; object-fit: cover;">
                                                 <div class="hover-title">Sirao Garden</div>
                                             </div>
                                         </div>
                                     </div>
