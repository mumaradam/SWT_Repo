...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/moalboal_day_header.jpg');">
        <div class="container position-relative">
            <h1>Moalboal Day Tour</h1>
            <p>Sardine Run & Turtle Snorkeling Adventure</p>
                    ...
                    <div class="p-4 shadow-sm rounded bg-white border">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="12" class="inclusions-cell" style="font-size: 0.9rem;">
                                        ...
                                        <ul class="ps-3 mt-2">
                                            ...
                                            <li>Lunch at Club Serena Resort </li>
                                            <li>Pick up & Drop off (Cebu & Mactan Hotel)</li>
                                            <li>Moalboal Island Hopping-Boat, Environment Fees</li>
                                            <li>Day Use at Club Serena Resort - use of beach and pool, 30 min kayak or paddleboard</li>
                                        </ul>
                                        <strong>Highlights:</strong>
                                        <ul class="ps-3 mt-2">
                                            <li>Moalboal Island Hopping: Turtle Point, Pescador Island, Sardine Run</li>
                                            <li>Club Serena Resort Day Use</li>
                                        </ul>
                                        <strong>Itinerary::</strong>
                                        <ul class="ps-3 mt-2">
                                            <li>04:00 AM Pick up Hotel</li>
                                            <li>07:00 AM Arrive Moalboal, Briefing Island hopping 2-3 hrs</li>
                                            <li>10:00 AM Club Serena Resort - Swimming, Kayak, Paddle Boarding</li>
                                            <li>12:00 PM Lunch</li>
                                            <li>01:00 PM Depart Club Serena</li>
                                            <li>05:00 PM Drop off Hotel</li>
                                        </ul>
                                        <div class="mt-3 p-2 border-top">
                                            <strong>Note:</strong> Underwater sightings of turtles and sardines are common but subject to nature. Proper swimwear and sun protection are recommended.
                                        </div>
                                    </td>
                                </tr>
                                <tr><td>2 Persons</td><td>PHP 4,200</td></tr>
                                <tr><td>3 Persons</td><td>PHP 3,300</td></tr>
                                <tr><td>4 Persons</td><td>PHP 2,800</td></tr>
                                <tr><td>5 Persons</td><td>PHP 2,500</td></tr>
                                <tr><td>6-12 Persons</td><td>PHP 2,200</td></tr>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                ...
                                <tr><th class="bg-light">Schedule</th><td>Daily | <strong>Pick up time: 6:00 AM (Flexible)</strong></td></tr>
                                <tr><th class="bg-light">Duration</th><td>12 Hours</td></tr>
                                <tr><th class="bg-light">Location</th><td>Moalboal</td></tr>
                                <tr><th class="bg-light">Value Added</th><td>Included Pick up and Drop off to any point of Cebu City and Mactan Hotel</td></tr>
                                 <tr>
