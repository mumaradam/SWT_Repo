<%@ Page Title="Bohol Countryside Day Tour" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DayTourBohol.aspx.cs" Inherits="seihaworldtravel.Tours.DayTourBohol" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/bohol_header.jpg');">
        <div class="container position-relative">
            <h1>Bohol Countryside Day Tour</h1>
            <p>Chocolate Hills & Loboc River Cruise</p>
                    ...
                    <div class="p-4 shadow-sm rounded bg-white border">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td rowspan="12" class="inclusions-cell" style="font-size: 0.9rem;">
                                        ...
                                        <ul class="ps-3 mt-2">
                                            <li>Roundtrip Cebu / Mactan Hotels to Pier Transfers</li>
                                            <li>Roundtrip Fast Ferry Tickets(Cebu-Tagbilaran-Cebu) with Hand Carry luggage only</li>
                                            <li>Airconditioned Transportation in Bohol</li>
                                            <li>Buffet Lunch at the Loboc Floating Restaurant</li>
                                            <li>Tour Guide</li>
                                            <li>All Enteance Fees</li>
                                            <li><strong>Exclusions:</strong> Seaport Terminal Fee and 15kl luggage allowance for Ferry Trip</li>
                                        </ul>
                                        <strong>Highlights:</strong>
                                        <ul class="ps-3 mt-2">
                                            <li>Blood Compact Shrine</li>
                                            <li>Baclayon Church "The Ruins" and Museum</li>
                                            <li>Loboc River Cruise with Lunch on Board</li>
                                            <li>Loay Backyard Industry</li>
                                            <li>Clarin Ancestral House</li>
                                            <li>Tarsier Encounter</li>
                                            <li>Chocolate Hills</li>
                                            <li>Manmade Forest</li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr><td>2 Persons</td><td>PHP 6,200</td></tr>
                                <tr><td>3 Persons</td><td>PHP 5,100</td></tr>
                                <tr><td>4 Persons</td><td>PHP 4,500</td></tr>
                                <tr><td>5 Persons</td><td>PHP 4,100</td></tr>
                                <tr><td>6-12 Persons</td><td>PHP 3,800</td></tr>
                                <tr><td>7 Persons</td><td>PHP 3,800</td></tr>
                                <tr><td>8 Persons</td><td>PHP 3,800</td></tr>
                                <tr><td>9 Persons</td><td>PHP 3,800</td></tr>
                                <tr><td>10 Persons</td><td>PHP 3,800</td></tr>
                                <tr><td>11 Persons</td><td>PHP 3,800</td></tr>
                                <tr><td>12 Persons</td><td>PHP 3,800</td></tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                ...
                                <tr><th class="bg-light">Schedule</th><td><strong>Daily</strong> <br /> <strong>Pick up time:</strong><br /> 5:00 AM for Cebu City Hotels | 4:30 AM for Mactan Hotels</td></tr>
                                <tr><th class="bg-light">Duration</th><td>Bohol Tour Estimate 6-7 Hours<br />Travel time:<br /> <strong>Cebu To Tagbilaran</strong> - 2 Hours <br /> <strong>Tagbilaran to Cebu</strong> - 2 Hours</td></tr>
                                <tr><th class="bg-light">Location</th><td>Bohol </td></tr>
                                <tr>
                                    <th class="bg-light">Child Rate</th>
                                    <td>3 years old & below – <strong>Free (Lap seat)</strong><br />
                               ...
                               <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        • 48 hours prior to tour – 20% Surcharge Fee <br />
                                        • 24 hours prior to tour – 50% Surcharge Fee <br />
                                        • 12 hours prior to tour– 100%<br />
