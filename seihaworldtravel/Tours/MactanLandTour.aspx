<%@ Page Title="Mactan Island Land Tour -" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MactanLandTour.aspx.cs" Inherits="seihaworldtravel.Tours.MactanLandTour" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/mactan_roses_header.jpg');">
        <div class="container position-relative">
            <h1>Mactan Island Land Tour with 10 Thousand Roses</h1>
            <p>10,000 Roses & Cultural Heritage</p>
                    ...
                    <div class="p-4 shadow-sm rounded bg-white border">
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td rowspan="12" class="inclusions-cell" style="font-size: 0.9rem;">
                                        ...
                                        <ul class="ps-3 mt-2">
                                            ...
                                            <li>Tour Guide (or without tour guide)</li>
                                            <li>Pick up Hotel and Drop off</li>
                                        </ul>
                                        <strong>Highlights:</strong>
                                        <ul class="ps-3 mt-2">
                                            <li>Magellan's Shrine</li>
                                            <li>Lapu-Lapu Shrine</li>
                                            <li>10 Thousand Roses Cafe</li>
                                ...
                                <tr><td>6 Persons</td><td>PHP 1,450</td></tr>
                                ...
                                <tr><td>13 Persons</td><td>Contact us for special quote</td></tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                ...
                                <tr><th class="bg-light">Schedule</th><td>Daily | <strong>Pick up time: 1:00 PM </strong></td></tr>
                                <tr><th class="bg-light">Duration</th><td>4 Hours</td></tr>
