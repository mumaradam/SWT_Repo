...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/oslobkawasan_header.jpg');">
        <div class="container position-relative">
            <h1>Oslob Whale Shark & Kawasan Falls</h1>
            <p>The Ultimate Southern Cebu Adventure</p>
                    ...
                    <div class="p-4 shadow-sm rounded bg-white border">
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td rowspan="12" class="inclusions-cell" style="font-size: 0.9rem;">
                                        ...
                                        <ul class="ps-3 mt-2">
                                            ...
                                            <li>Lunch at Kawasan Falls</li>
                                            <li>Pick up & Drop off (Cebu City & Mactan Hotel) Kawasan Falls</li>
                                            <li>Entrance Fees & Local Guide</li>
                                            <li>Hotel Pick-up and Drop-off (Cebu/Mactan)</li>
                                        </ul>
                                        <strong>Whaleshark Encounter:</strong>
                                        <ul class="ps-3 mt-2">
                                            <li>Whale Shark Encounter Briefing & Permit</li>
                                            <li>Whale Shark Viewing Fee ONLY</li>
                                ...
                                <tr><td>2 Persons</td><td>PHP 6,100</td></tr>
                                <tr><td>3 Persons</td><td>PHP 4,900</td></tr>
                                <tr><td>4 Persons</td><td>PHP 4,300</td></tr>
                                <tr><td>5 Persons</td><td>PHP 3,900</td></tr>
                                <tr><td>6-12 Persons</td><td>PHP 3,500</td></tr>
                                <tr><td>7 Persons</td><td>PHP 3,500</td></tr>
                                <tr><td>8 Persons</td><td>PHP 3,500</td></tr>
                                <tr><td>9 Persons</td><td>PHP 3,500</td></tr>
                                <tr><td>10 Persons</td><td>PHP 3,500</td></tr>
                                <tr><td>11 Persons</td><td>PHP 3,500</td></tr>
                                <tr><td>12 Persons</td><td>PHP 3,500</td></tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                ...
                                <tr><th class="bg-light">Schedule</th><td>Daily - Monday to Sunday | <strong>Pick up time: 3:00 AM</strong></td></tr>
                                <tr><th class="bg-light">Duration</th><td>13 Hours</td></tr>
                                <tr><th class="bg-light">Location</th><td>Oslob & Badian, South Cebu(3 hours travel duration from City) & Samboan, Cebu</td></tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>Every 3<sup>rd</sup> Wednesday of the month for clean up.<br /><strong>SINULOG:</strong> January 18-19 | <strong>CHRISTMAS:</strong> December 24-25 | <strong>NEW YEAR:</strong> December 31-Jan 1 | <strong> HOLY WEEK:</strong> April 2-3</td>
                                </tr>
                                <tr>
