...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/triple_adventure_header.jpg');">
        <div class="container position-relative">
            <h1>Oslob Whale Shark, Kawasan Falls & Moalboal</h1>
            <p>The Ultimate Southern Cebu Triple Adventure</p>
            ...
            <div class="row">
                    ...
                    <div class="p-4 shadow-sm rounded bg-white border">
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            ...
                            <tbody>
                                <tr>
                                    <td>1 Person</td>
                                    <td>PHP 10,800</td>
                                    <td rowspan="12" class="inclusions-cell" style="font-size: 0.85rem;">
                                        ...
                                        <ul class="ps-3 mt-2">
                                            ...
                                            <li>Pick up adn Drop off (Cebu City & Mactan Hotel)</li>
                                        </ul>
                                        <strong>Kawasan Falls & Sardine Run:</strong>
                                        <ul class="ps-3 mt-2">
                                        ...
                                        <ul class="ps-3 mt-2">
                                            ...
                                            <li>Kawasan Falls</li>
                                            <li>Sardine Run | Turtles </li>
                                        </ul>
                                        
                                    </td>
                                </tr>
                                <tr><td>2 Persons</td><td>PHP 7,500</td></tr>
                                <tr><td>3 Persons</td><td>PHP 6,200</td></tr>
                                <tr><td>4 Persons</td><td>PHP 5,600</td></tr>
                                <tr><td>5 Persons</td><td>PHP 5,100</td></tr>
                                <tr><td>6-12 Persons</td><td>PHP 4,700</td></tr>
                                <tr><td>7 Persons</td><td>PHP 4,700</td></tr>
                                <tr><td>8 Persons</td><td>PHP 4,700</td></tr>
                                <tr><td>9 Persons</td><td>PHP 4,700</td></tr>
                                <tr><td>10 Persons</td><td>PHP 4,700</td></tr>
                                <tr><td>11 Persons</td><td>PHP 4,700</td></tr>
                                <tr><td>12 Persons</td><td>PHP 4,700</td></tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                ...
                                <tr>
                                    <th class="bg-light" style="width: 35%;">Add on the DOT Guide</th>
                                    <td>1-4 Pax : P 4000 &emsp;	5-9 Pax : P 4500 &emsp;	10-12 Pax : P5000<br /></td>
                                </tr>
                                <tr><th class="bg-light">Schedule</th><td>Daily - Monday to Sunday | <strong>Pick up time: 3:00 AM</strong></td></tr>
                                <tr><th class="bg-light">Duration</th><td>14 Hours</td></tr>
                                <tr><th class="bg-light">Location</th><td>Oslob, South of Cebu (3 hours travel duration from City) Moalboal & Badian</td></tr>
                                <tr>
                ...
                <div class="col-lg-5">
                    <div class="p-4 shadow-sm rounded bg-white border" style="position: sticky; top: 100px;">
                        <h3 class="mb-3" style="color: #f79421; font-weight: 700;">Book This Triple Tour</h3>
