...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/10kRoses.png');">
        <div class="container position-relative">
            <h1>CEBU CITY TOUR & 10 THOUSAND ROSES WITH DINNER</h1>
            <p>The Ultimate Cebu Experience </p>
                    ...
                    <div class="p-4 shadow-sm rounded bg-white border">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="12" class="inclusions-cell" style="font-size: 0.9rem;">
                                        ...
                                        <ul class="ps-3 mt-2">
                                            ...
                                            <li>DOT Tour Guide or Tour Coordinator</li>
                                            <li>Hotel Pick-up and Drop-off</li>
                                        </ul>
                                        <strong>Highlights:</strong>
                                        <ul class="ps-3 mt-2">
                                            <li>10 Thousand Roses </li>
                                            <li> Magellan's Cross</li>
                                            <li>Basillica Del Sto. Nino</li>
                                            <li>The Heritage of Cebu </li>
                                            <li>Fort San Pedro or NAtional Museum </li>
                                            <li>Running Tour: CCLEX Bridge, South Road Properties </li>
                                        </ul>
                                        <div class="alert alert-warning py-2 mt-3" style="font-size: 0.8rem;">
                                            <strong>Note:</strong> Wearing of sleeveless shirts, shorts and ripped pants is not allowed inside the Sto. Nino Church.
                                        </div>
                                    </td>
                                </tr>
                                <tr><td>2 Persons</td><td>PHP 4,400</td></tr>
                                <tr><td>3 Persons</td><td>PHP 3,400</td></tr>
                                <tr><td>4 Persons</td><td>PHP 2,900</td></tr>
                                <tr><td>5 Persons</td><td>PHP 2,600</td></tr>
                                <tr><td>6 Persons</td><td>PHP 2,200</td></tr>
                                <tr><td>7 Persons</td><td>PHP 2,200</td></tr>
                                <tr><td>8 Persons</td><td>PHP 2,200</td></tr>
                                <tr><td>9 Persons</td><td>PHP 2,200</td></tr>
                                <tr><td>10 Persons</td><td>PHP 2,200</td></tr>
                                <tr><td>11 Persons</td><td>PHP 2,200</td></tr>
                                <tr><td>12 Persons</td><td>PHP 2,200</td></tr>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                ...
                                <tr><th class="bg-light">Schedule</th><td>Daily | <strong>Pick up time: 2:00 PM</strong></td></tr>
                                <tr><th class="bg-light">Duration</th><td>5-6 Hours</td></tr>
                                <tr><th class="bg-light">Location</th><td>Cebu City, Cordova</td></tr>
                                <tr><th class="bg-light">Value Added</th><td>Included Pick up and Drop off to any Hotel or any point of Cebu City and Mactan</td></tr>
                                <tr>
                                ...
                                <tr><th class="bg-light">NO TOUR</th><td><strong>SINULOG:</strong> January 18-19 | <strong>CHRISTMAS:</strong> December 24-25 | <strong>NEW YEAR:</strong> December 31-Jan 1 | <strong> HOLY WEEK:</strong> April 2-3</td></tr>
                                ...
                                <tr>
                                    ...
                                    <td>• 24 hours prior to tour – 20% Surcharge Fee <br />
                                        • 12 hours prior to Tour – 50% Surcharge Fee <br />
                                        • Less than 12 hours – 100%<br />
                                        • Refunds will be processed within 14 working days..</td>
                                    </tr>
                                <tr>
                             ...
                             <div id="tourGalleryCarousel" class="carousel slide shadow-sm rounded overflow-hidden mb-4" data-bs-ride="carousel">
                                 ...
                                 <div class="carousel-inner">
                                     ...
                                     <div class="carousel-item">
                                         <div class="gallery-item-wrapper">
                                             <img src="../../assets/dot/10kRoses.png" class="d-block w-100" alt="10k Roses" style="height: 400px; object-fit: cover;">
                                             <div class="hover-title">10, 000 Roses</div>
                                         </div>
                                     </div>
