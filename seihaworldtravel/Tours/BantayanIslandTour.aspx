...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/bantayan_header.jpg');">
        <div class="container position-relative">
            <h1>Bantayan Island Day Tour</h1>
            <p>Paradise Found in Northern Cebu</p>
            ...
            <div class="row">
                    ...
                    <div class="p-4 shadow-sm rounded bg-white border">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td rowspan="12" class="inclusions-cell" style="font-size: 0.9rem;">
                                        ...
                                        <ul class="ps-3 mt-2">
                                            <li>Non airconditioned Transportation (local transport)</li>
                                        ...
                                        <ul class="ps-3 mt-2">
                                            <strong><u>Land Tour</u></strong>
                                            <li>Camp Sawi (Sand Bar)</li>
                                            <li>The Ruins (Cliff Diving Spot)</li>
                                            <li>Obo-ob Mangroves</li>
                                            <li>Paradise Beach</li>
                                            <li>Ogtong Cave</li>
                                            <strong><u>Island Hopping</u></strong>
                                            <li>Virgin Island</li>
                                            <li>Baigad Lagoon</li>
                                        </ul>
                                    </td>
                                ...
                                <tr><td>3 Persons</td><td>PHP 4,200</td></tr>
                                <tr><td>4 Persons</td><td>PHP 3,700</td></tr>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                ...
                                <tr><th class="bg-light">Schedule</th><td>Daily - Monday to Sunday | <strong>Pick up time: 8:00 AM </strong></td></tr>
                                <tr><th class="bg-light">Duration</th><td>6-8 Hours</td></tr>
                                <tr><th class="bg-light">Location</th><td>Sta. Fe Bantayan Island, Cebu</td></tr>
                                 <tr>
                ...
                <div class="col-lg-5">
                    <div class="p-4 shadow-sm rounded bg-white border" style="position: sticky; top: 100px;">
                        <h3 class="mb-3" style="color: #f79421; font-weight: 700;">Book This Island Tour</h3>
