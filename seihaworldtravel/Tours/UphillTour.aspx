...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/uphillheader.jpg');">
        <div class="container position-relative">
            <h1>Uphill Tour</h1>
            <p>Cebu's Scenic Mountain Destinations</p>
                    ...
                    <div class="p-4 shadow-sm rounded bg-white border">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="12" class="inclusions-cell" style="font-size: 0.9rem;">
                                        ...
                                        <ul class="ps-3 mt-2">
                                            ...
                                            <li>Taoist Temple </li> 
                                            <br />
                                            <li> <strong> Exclusions: </strong> Meals and Drinks </li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr><td>2 Persons</td><td>PHP 3,000</td></tr>
                                <tr><td>3 Persons</td><td>PHP 2,200</td></tr>
                                <tr><td>4 Persons</td><td>PHP 1,900</td></tr>
                                <tr><td>5 Persons</td><td>PHP 1,700</td></tr>
                                <tr><td>6-12 Persons</td><td>PHP 1,500</td></tr>
                                <tr><td>7 Persons</td><td>PHP 1,500</td></tr>
                                <tr><td>8 Persons</td><td>PHP 1,500</td></tr>
                                <tr><td>9 Persons</td><td>PHP 1,500</td></tr>
                                <tr><td>10 Persons</td><td>PHP 1,500</td></tr>
                                <tr><td>11 Persons</td><td>PHP 1,500</td></tr>
                                <tr><td>12 Persons</td><td>PHP 1,500</td></tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                ...
                                <tr><th class="bg-light">Schedule</th><td>Daily | <strong>Pick up time: 10:00 AM (Flexible)</strong></td></tr>
                                <tr><th class="bg-light">Duration</th><td>4-5 Hours</td></tr>
                                <tr><th class="bg-light">Location</th><td>Cebu City - Busay, Cantipla</td></tr>
                                <tr>
                                ...
                                <tr><th class="bg-light">NO TOUR</th>
                                    <td>
                                        <strong>SINULOG:</strong> January 18-19 | <strong>CHRISTMAS:</strong> December 24-25 | <strong>NEW YEAR:</strong> December 31-Jan 1 | <strong> HOLY WEEK:</strong> April 2-3</td> </tr>
