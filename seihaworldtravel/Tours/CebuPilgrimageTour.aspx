<%@ Page Title="Cebu Pilgrimage Tour -" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CebuPilgrimageTour.aspx.cs" Inherits="seihaworldtravel.Tours.CebuPilgrimageTour" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/pilgrimage_header.jpg');">
        <div class="container position-relative">
            <h1>Cebu Pilgrimage Tour</h1>
            <p>A Journey of Faith and History</p>
                    ...
                    <div class="p-4 shadow-sm rounded bg-white border">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="12" class="inclusions-cell" style="font-size: 0.9rem;">
                                        ...
                                        <ul class="ps-3 mt-2">
                                            ...
                                            <li>Lunch at a local Lechon House in Carcar</li>
                                            <li>Tour Guide</li>
                                        ...
                                        <ul class="ps-3 mt-2">
                                            <li>Simala Shrine</li>
                                            <li>Teofilo Camomot Shrine</li>
                                            <li>Theotokos Shrine</li>
                                            <li>Chapel of San Pedro Calungsod</li>
                                            <li>Basilica Minore Del Sto. Nino</li>
                                            <li>Magellan's Cross</li>
                                            <li>Cebu Metropolitan Cathedral</li>
                                        </ul>
                                        <div class="mt-3 p-2 border-top">
                                            <strong>Note:</strong> Wearing of sleeveless shirt, short and ripped pants is not allowed inside the church.
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                ...
                                <tr><th class="bg-light">Location</th><td>Cebu City, Sibonga & Carcar</td></tr>
                               <tr>
