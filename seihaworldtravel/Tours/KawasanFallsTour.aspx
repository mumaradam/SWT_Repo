...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/kawasan_main_header.jpg');">
        <div class="container position-relative">
            <h1>Kawasan Waterfalls Adventure</h1>
            <p>Breathtaking Turquoise Waters & Scenic South Cebu</p>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered tour-table mb-4 text-center" style="font-size: 0.85rem;">
                                <thead class="table-primary text-white">
                                    <tr>
                                        <th>Pax</th>
                                        <th>A. Kawasan + Lambug Beach</th>
                                        <th>B. Kawasan + Osmeña Peak</th>
                                        <th>C. Kawasan + Moalboal</th>
                                    </tr>
                                </thead>
                                <tbody class="fw-bold">
                                    <tr><td>1</td><td>PHP 6,500</td><td>PHP 7,500</td><td>PHP 8,500</td></tr>
                                    <tr><td>2</td><td>PHP 3,800</td><td>PHP 4,500</td><td>PHP 5,300</td></tr>
                                    <tr><td>3</td><td>PHP 3,000</td><td>PHP 3,500</td><td>PHP 4,300</td></tr>
                                    <tr><td>4</td><td>PHP 2,500</td><td>PHP 3,000</td><td>PHP 3,800</td></tr>
                                    <tr><td>5</td><td>PHP 2,200</td><td>PHP 2,700</td><td>PHP 3,400</td></tr>
                                    <tr><td>6-12</td><td>PHP 1,900</td><td>PHP 2,400</td><td>PHP 3,100</td></tr>
                                </tbody>
                            </table>
                        </div>

                        <div class="mb-5">
                            <h5 class="fw-bold text-primary border-bottom pb-2">A. Kawasan Falls & Lambug Beach</h5>
                            <p class="small mb-4"><strong>Highlights:</strong> <br />- Turquoise waters of Kawasan Falls <br />- The pristine white sand of Lambug Beach in Badian.<br />
                            <strong>Inclusions:</strong> Air-con Transpo, Licensed Guide, Entrance Fees, and Lunch with drinks.<br />
                                <strong>TourDuration:</strong> <br />
                                10 Hours<br />
                                <strong>Pick up:</strong> <br />
                                5:00AM <br />
                                <strong>Itinerary:</strong> <br />
                                05:00 AM Pick Up Hotel <br/>
                                08:00 AM Arrive Lambug Bridge <br/>
                                10:00 AM Proceed to Kawasan Falls 20 to 30 mins trek to Kawasan Swimming <br/>
                                12:00 PM Lunch <br/>
                                01:30 PM Depart Badian <br/>
                                05:00 PM Drop Off Hotel <br/>
                            </p>
                            

                            <h5 class="fw-bold text-primary border-bottom pb-2">B. Kawasan Falls & Osmeña Peak</h5>
                            <p class="small mb-4"><strong>Highlights:</strong><br /> Scenic trek to Cebu's highest point (Osmeña Peak) followed by a refreshing dip in Kawasan Falls.<br />
                            <strong>Inclusions:</strong> Air-con Transpo, Guide, Osmeña Peak Entrance & Coordinator, Kawasan Fees, and Lunch.
                                    <strong>TourDuration:</strong> <br />
                                    12 Hours<br />
                                    <strong>Pick up:</strong> <br />
                                    6:00AM <br />
                                    <strong>Itinerary:</strong> <br />
                                    06:00 AM Pick Up Hotel <br/>
                                    08:00 AM Arrive Dalaguete <br/>
                                    08:30 AM Trek to Osmena Peak (20 - 30 mins) Enjoy the view at O peak <br/>
                                    10:30 AM Depart for Badian <br/>
                                    12:00 PM Arrive Badian 20 - 30 mins trek to Kawasan Falls swimming & Lunch<br/>
                                    03:00 PM Depart Badian <br/>
                                    06:00 PM Drop Off Hotel<br/>
                                </p>

                            </p>

                            <h5 class="fw-bold text-primary border-bottom pb-2">C. Kawasan Falls & Moalboal Island Hopping</h5>
                            <p class="small"><strong>Highlights:</strong> Snorkeling with the Sardine Run & Sea Turtles in Moalboal, followed by the turquoise falls of Badian.<br />
                            <strong>Inclusions:</strong> Air-con Transpo, Guide, Boat Fees, Snorkeling Gears, All Entrance Fees, and Lunch.
                                    <strong>TourDuration:</strong> <br />
                                    12 Hours<br />
                                    <strong>Pick up:</strong> <br />
                                    4:00AM <br />
                                    <strong>Itinerary:</strong> <br />
                                    04:00 AM Pick Up Hotel <br/>
                                    07:00 AM Arrive Moalboal, Island Hopping Pescador Island, Turtle Point, Sardines Run <br/>
                                    10:00 AM Depart Moalboal <br/>
                                    11:00 AM Arrive Badian 20 - 30 mins trek to Kawasan Swimming, Lunch <br/>
                                    01:00 PM Depart Badian <br/>
                                    04:00 PM Drop Off Hotel <br/>
                                </p>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                <tr>
                                    ...
                                    <td>1-4 Pax : P 3500 &emsp;	5-9 Pax : P 4000 &emsp;	10-12 Pax : P4500<br />
                                </tr>
                                <tr>
                ...
                <div class="col-lg-5">
                    <div class="p-4 shadow-sm rounded bg-white border" style="position: sticky; top: 100px;">
                        ...
                        <div class="mb-3">
                            ...
                            <asp:DropDownList ID="ddlKawasanPackage" runat="server" CssClass="form-select">
                                <asp:ListItem Text="A. Kawasan + Lambug Beach" Value="A"></asp:ListItem>
                                <asp:ListItem Text="B. Kawasan + Osmeña Peak" Value="B"></asp:ListItem>
                                <asp:ListItem Text="C. Kawasan + Moalboal" Value="C"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
