<%@ Page Title="Cebu City with Simala Shrine -" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SimalaShrineTour.aspx.cs" Inherits="seihaworldtravel.Tours.SimalaShrineTour" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/simalaheader.jpg');">
        <div class="container position-relative">
            <h1>Cebu City with Simala Shrine</h1>
            <p>A Journey of Faith and Heritage</p>
                        ...
                        <h3 class="mb-4" style="color: #012970; font-weight: 700;">Rate and Inclusions</h3>
                            <table class="table table-bordered tour-table mb-5">
                                ...
                                <tbody>
                                    ...
                                    <tr><td>3 Persons</td><td>PHP 3,000</td></tr>
                                    <tr><td>4 Persons</td><td>PHP 2,500</td></tr>
                                    <tr><td>5 Persons</td><td>PHP 2,200</td></tr>
                            ...
                            <table class="table table-bordered tour-table mb-5">
                                <tbody>
                                    ...
                                    <tr><th class="bg-light">Schedule</th><td>Daily | <strong>Pick up time: 7:00 AM </strong></td></tr>
                                    <tr><th class="bg-light">Duration</th><td>9 Hours</td></tr>
                                    <tr><th class="bg-light">Location</th><td>Sibonga & Cebu City</td></tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>• 1-3 Pax: <strong>Car</strong><br />
                                            • 4-6 Pax: <strong>Innova</strong><br />
                                            • 7-12 Pax: <strong> Van</strong></td>
                                    </tr>
                                </tbody>
                            </table>
