<%@ Page Title="Jubilee Journey: Cebu's Pilgrim Churches" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="JubileeJourney.aspx.cs" Inherits="seihaworldtravel.Tours.JubileeJourney" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/jubilee_header.jpg');">
        <div class="container position-relative">
            <h1>Jubilee Journey: Cebu's Pilgrim Churches</h1>
            <p>A Spiritual Pilgrimage to Cebu's Sacred Doors</p>
            ...
            <div class="row">
                    ...
                    <div class="p-4 shadow-sm rounded bg-white border">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="12" class="inclusions-cell" style="font-size: 0.9rem;">
                                        ...
                                        <ul class="ps-3 mt-2">
                                            ...
                                            <li>Basilica Minore del Sto. Nino de Cebu</li>
                                            <li>Our Lady of Mount Carmel</li>
                                            <li>Archdiocesan Shrine of the Most Sacred Heart of Jesus</li>
                                            <li>Archdiocesan Shrine of the Lady of Guadalupe</li>
                                            <li>Archdiocesan Shrine of St. Therese of the Child Jesus</li>
                                            <li>Parish and National Shrine of Virgen de Regla</li>
                                        </ul>
                                        <div class="mt-3 p-2 border-top">
                                            <strong>Note:</strong> Wearing of sleeveless shirt, short adn ripped pants is not allowed inside the church.
                                        </div>
                                    </td>
                                </tr>
                                <tr><td>2 Persons</td><td>PHP 3,800</td></tr>
                                <tr><td>3 Persons</td><td>PHP 3,100</td></tr>
                                <tr><td>4 Persons</td><td>PHP 2,700</td></tr>
                                <tr><td>5 Persons</td><td>PHP 2,400</td></tr>
                                <tr><td>6-12 Persons</td><td>PHP 2,100</td></tr>
                                <tr><td>7 Persons</td><td>PHP 2,100</td></tr>
                                <tr><td>8 Persons</td><td>PHP 2,100</td></tr>
                                <tr><td>9 Persons</td><td>PHP 2,100</td></tr>
                                <tr><td>10 Persons</td><td>PHP 2,100</td></tr>
                                <tr><td>11 Persons</td><td>PHP 2,100</td></tr>
                                <tr><td>12 Persons</td><td>PHP 2,100</td></tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                ...
                                <tr><th class="bg-light">Schedule</th><td>Daily - Monday to Sunday <strong>Pick up time: 7:00 AM</strong></td></tr>
                                <tr><th class="bg-light">Duration</th><td>8 Hours</td></tr>
                                <tr><th class="bg-light">Location</th><td>Mactan & Cebu City </td></tr>
                                            <tr>
                ...
                <div class="col-lg-5">
                    <div class="p-4 shadow-sm rounded bg-white border" style="position: sticky; top: 100px;">
                        <h3 class="mb-3" style="color: #f79421; font-weight: 700;">Book This Pilgrimage</h3>
