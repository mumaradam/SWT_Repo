...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/watersports_header.jpg');">
        <div class="container position-relative">
            <h1>3 in 1 Water Adventure</h1>
            <p>Parasailing, Jetski, & Banana Boat</p>
                    ...
                    <div class="p-4 shadow-sm rounded bg-white border">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="12" class="inclusions-cell" style="font-size: 0.9rem;">
                                        ...
                                        <ul class="ps-3 mt-2">
                                            ...
                                            <li>Towels and Life Vest</li>
                                            <li>Watersport crew / Instructor</li>
                                        ...
                                        <ul class="ps-3 mt-2">
                                            <li>Parasailing</li>
                                            <li>Jey Ski (30 minutes)</li>
                                            <li>Banana Boat</li>
                                        </ul>
                                        <div class="mt-3 p-2 border-top">
                                            <strong>Note:</strong> Participants must be in good physical health. Not recommended for pregnant women or individuals with back/heart conditions. Weather dependent.
                                        </div>
                                    </td>
                                </tr>
                                <tr><td>2 Persons</td><td>PHP 5,800</td></tr>
                                <tr><td>3 Persons</td><td>PHP 5,200</td></tr>
                                <tr><td>4 Persons</td><td>PHP 4,800</td></tr>
                                <tr><td>5 Persons</td><td>PHP 4,500</td></tr>
                                <tr><td>6-12 Persons</td><td>PHP 4,200</td></tr>
                                <tr><td>7 Persons</td><td>PHP 4,200</td></tr>
                                <tr><td>8 Persons</td><td>PHP 4,200</td></tr>
                                <tr><td>9 Persons</td><td>PHP 4,200</td></tr>
                                <tr><td>10 Persons</td><td>PHP 4,200</td></tr>
                                <tr><td>11 Persons</td><td>PHP 4,200</td></tr>
                                <tr><td>12 Persons</td><td>PHP 4,200</td></tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                ...
                                <tr><th class="bg-light">Schedule</th><td><strong>Daily</strong> - Monday to Sunday <br /> <strong>Pick up time:</strong> 8:00 AM </td></tr>
                                <tr><th class="bg-light">Duration</th><td>3-4 Hours (including travel time)</td></tr>
                                <tr><th class="bg-light">Location</th><td>Mactan Island</td></tr>
                                <tr>
                                    <th class="bg-light">Age Requirement</th>
                                    <td>8 years old to 60 years old</td>
                                </tr>
                                 <tr>
