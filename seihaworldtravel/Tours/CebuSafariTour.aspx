...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/safari_header.jpg');">
        <div class="container position-relative">
            <h1>Cebu Safari and Adventure Park</h1>
            <p>A World-Class Wildlife Experience in Northern Cebu</p>
                    ...
                    <div class="p-4 shadow-sm rounded bg-white border">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="12" class="inclusions-cell" style="font-size: 0.9rem;">
                                        ...
                                        <ul class="ps-3 mt-2">
                                            ...
                                            <li>Cebu Safari Adventure Park Fees</li>
                                            <li>Entrance to the Park</li>
                                            <li>Use of Tram Rides from Tram stop to Tram stop</li>
                                            <li>White Lion</li>
                                            <li>African Savanna Tour</li>
                                            <li>Bird Show at the Safari Stadium 1:45 pm (seats upon avialability/First come first serve basis)</li>
                                            <li>Access to all the animal viewing areas</li>
                                            <li>Access to Michel's Garden</li>
                                            <li>Access to Gardens of the World</li>
                                        </ul>
                                        <strong>Highlights:</strong>
                                        <ul class="ps-3 mt-2">
                                            <li>Cebu Safari Adventure Park</li>
                                            <li>TItays Rosquillos and Pasalubong Shop </li>
                                        </ul>
                                        <strong>Itinerary:</strong><br />
                                        8:00 AM Hotel pick up <br />
                                        10:00 AM Arrive Safari Park Tour around the park <br />
                                        11:30 AM Lunch <br />
                                        1:30 AM Proceed to the Safari stadium for the Bird Show <br />
                                        1:45 AM Bird Show <br />
                                        2:45 AM Depart Safari Adventure Park<br />
                                    </td>
                                </tr>
                                <tr><td>2 Persons</td><td>PHP 3,900</td></tr>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                ...
                                <tr>
                                    <th class="bg-light" style="width: 35%;">Tour Duration</th>
                                    <td>10 Hrs<br />
                                </tr>
                                <tr><th class="bg-light">Park Schedule</th><td><strong>Daily: </strong>8:00 AM - 5:00 PM</td></tr>
                                <tr><th class="bg-light">Exclusions</th><td>Zipbike, Zipline, ATV</td></tr>
                                <tr><th class="bg-light">Location</th><td>Toril, Corte, Carmen Cebu (approx. 1.5 - 2 hrs drive from Cebu City)</td></tr>
                               <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        • 3-5 Pax: <strong>Innova</strong><br />
                                        • 6-12 Pax: <strong>Van</strong><br />
                                        • 13-14 Pax: <strong> Big Van (Joylong)</strong>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
