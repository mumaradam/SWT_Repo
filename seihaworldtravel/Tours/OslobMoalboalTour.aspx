...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/moalboal_header.jpg');">
        <div class="container position-relative">
            <h1>Oslob Whale Shark & Moalboal Sardine Run</h1>
            <p>Southern Cebu Marine Adventure</p>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered tour-table mb-4 text-center" style="font-size: 0.9rem;">
                                <thead class="table-primary text-white">
                                    <tr>
                                        <th>Pax</th>
                                        <th>Option 1: With Boat (Pescador Island)</th>
                                        <th>Option 2: No Boat (Shore Snorkeling)</th>
                                    </tr>
                                </thead>
                                <tbody class="fw-bold">
                                    <tr><td>1</td><td>PHP 8,500</td><td>PHP 7,500</td></tr>
                                    <tr><td>2</td><td>PHP 5,500</td><td>PHP 4,800</td></tr>
                                    <tr><td>3</td><td>PHP 4,400</td><td>PHP 3,900</td></tr>
                                    <tr><td>4</td><td>PHP 3,900</td><td>PHP 3,400</td></tr>
                                    <tr><td>5</td><td>PHP 3,600</td><td>PHP 3,100</td></tr>
                                    <tr><td>6-12</td><td>PHP 3,300</td><td>PHP 2,800</td></tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <ul class="ps-3 mt-2">
        ...
        <li>Snacks upon arrival in Oslob</li>
        <li>Lunch at a local resto in Moalboal</li>
        <li>Pick up and Drop off at any Cebu City & Mactan Hotel/Resort</li>
    </ul>
    <strong>Whaleshark Encounter:</strong>
    <ul class="ps-3 mt-2">
        <li>Whaleshark Encounter Briefing & Permit</li>
        <li>Banca (boat) with steward </li>
        <li>Moalboal Snorkeling</li>
        <li>Boat for option 1, Environmental Fees, Snorkeling mask</li>
    </ul>
    <strong>Highlights:</strong>
    <ul class="ps-3 mt-2">
        <li>Whaleshark Encounter</li>
        <li>Moalboal Snorkeling: Turtle Point, Sardine Run</li>
        <li>For Option 1 only: Pescador Island</li>
    </ul>
    <strong>Itinerary:</strong>
    <ul class="ps-3 mt-2">
        <li>03: 00 AM  Pick up Hotel</li>
        <li>06: 00 AM  Arrive Oslob, Snacks, Briefing Whaleshark Encounter(30mins)</li>
        <li>07: 30 AM  Depart Oslob for Moalboal</li>
        <li>09: 30 AM  Arrive Moalboal - Sardine Run, Turtle</li>
        <li>12: 00 AM  Lunch at local resto</li>
        <li>01: 00 AM  Depart Moalboal</li>
        <li>04: 00 AM  Drop off Hotel</li>
    </ul>
                        ...
                        <table class="table table-bordered tour-table mb-5">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>1-4 Pax : P 3500 &emsp; 5-9 Pax : P 4000  &emsp; 10-12 Pax : P4500<br /></td>
                                </tr>
                                <tr><th class="bg-light">Schedule</th><td>Daily | <strong>Pick up time: 4:00 AM</strong></td></tr>
                                <tr><th class="bg-light">Duration</th><td>13 Hours</td></tr>
                                <tr><th class="bg-light">Location</th><td>Oslob & Moalboal</td></tr>
                                 <tr>
                ...
                <div class="col-lg-5">
                    <div class="p-4 shadow-sm rounded bg-white border" style="position: sticky; top: 100px;">
                        ...
                        <div class="mb-3">
                            ...
                            <asp:DropDownList ID="ddlMoalboalOption" runat="server" CssClass="form-select">
                                <asp:ListItem Text="Option 1: With Boat (Pescador)" Value="Boat"></asp:ListItem>
                                <asp:ListItem Text="Option 2: No Boat (Shore Only)" Value="Shore"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
