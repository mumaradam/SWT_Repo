...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-title dark-background" data-aos="fade" style="background-image: url('../../assets/dot/sumilon_header.jpg');">
        <div class="container position-relative">
            <h1>Oslob Whale Shark & Sumilon Sandbar</h1>
            <p>Southern Cebu's Blue Waters</p>
                                ...
                                <tr>
                                    ...
                                    <td rowspan="12" class="inclusions-cell" style="font-size: 0.9rem;">
                                        ...
                                        <ul class="ps-3 mt-2">
                                            ...
                                            <li>Lunch at local restaurant with one round of softdrinks </li>
                                            <li>Motorized Boat</li>
                                            <li>Entrance Fee to Sumilon Sandbar </li>
                                            <li>Entrance Fee to Tumalog Falls</li>
                                        ...
                                        <ul class="ps-3 mt-2">
                                            ...
                                            <li>Whale Shark Viewing Fee & Snorkeling Fee</li>
                                            <li>Banca(boat) with steward</li>
                                        </ul>
                                        <strong>Highlights:</strong>
                                        <ul class="ps-3 mt-2">
                                            <li>Whale Shark Encounter</li>
                                            <li>Sumilon Sandbar</li>
                                            <li>Tumalog Falls</li>
                                            <li>Running Tour/Picture Taking: Baluarte, Cuartel, and Carcar Pasalubong</li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr><td>2 Persons</td><td>PHP 5,200</td></tr>
                                <tr><td>3 Persons</td><td>PHP 4,100</td></tr>
                                <tr><td>4 Persons</td><td>PHP 3,600</td></tr>
                                <tr><td>5 Persons</td><td>PHP 3,300</td></tr>
                                <tr><td>6-12 Persons</td><td>PHP 3,000</td></tr>
                                <tr><td>7 Persons</td><td>PHP 3,000</td></tr>
                                <tr><td>8 Persons</td><td>PHP 3,000</td></tr>
                                <tr><td>9 Persons</td><td>PHP 3,000</td></tr>
                                <tr><td>10 Persons</td><td>PHP 3,000</td></tr>
                                <tr><td>11 Persons</td><td>PHP 3,000</td></tr>
                                <tr><td>12 Persons</td><td>PHP 3,000</td></tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Net Rates each per person including pertinent taxes and service charge.<br />
                                        <strong>Add on for DOT Guide (English Speaking):</strong> PHP 3,500 /Group</td>
                                </tr>
                                <tr><th class="bg-light">Add on the DOT Guide </th><td>1-4 Pax: P 3,500 &emsp; 5-9 Pax: P 4,000 &emsp; 10-12 Pax: P4,500 </td></tr>
                                <tr><th class="bg-light">Schedule</th><td>Daily | <strong>Pick up time: 3:00 AM</strong></td></tr>
                                <tr><th class="bg-light">Duration</th><td>12 Hours</td></tr>
                                <tr><th class="bg-light">Location</th><td>Oslob, South of Cebu (3 hours travel duration from City)</td></tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><strong>Sumilon Sandbar & Tumalog falls CLOSED - Every 3<sup>rd</sup> Wednesday of the month for clean up <br /> </strong><strong>SINULOG:</strong> January 18-19 | <strong>CHRISTMAS:</strong> December 24-25 | <strong>NEW YEAR:</strong> December 31-Jan 1 | <strong> HOLY WEEK:</strong> April 2-3</td>
                                </tr>
                                <tr>
